...
export default function AccountButton() {
  ...
  return (
    <Link
      href="/signin"
      className="text-xs rounded-full px-3   h-[28px] md:h-[28px] flex items-center justify-center  bg-black text-white/90 tracking-tighter hover:bg-black/80 font-semibold"
    >
      Sign Up
    </Link>
  );
